...
class SlimSimulatorRacimo(DataSimulator):
    """
    ...
    slim_script_folder : str, optional
        ...
        out_id : str or None, optional
            Population ID for an additional outgroup. Default is None. (Not used by this simulator)
        nsrc : int, optional
            Number of source population individuals. Default is 1.
        nout : int or None, optional
            Number of individuals in the outgroup. Default is None. (Not used by this simulator)
        ...
        create_all_mutation_output : bool, optional
            Whether to output all mutation data. Default is False.
        ...
        settings : str, optional
            Simulation scenario to use: "maladapt", "uniform", or "default". Default is "default".
        ...
        ------
        Exception
            If an unsupported value for `settings` (currently only default) is provided.
    """
