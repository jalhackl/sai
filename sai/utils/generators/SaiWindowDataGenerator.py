...
class SaiWindowDataGenerator(DataGenerator):
    """
    ...
    def __init__(
        ...
        #from sai.utils.gaia_utils import read_data_src
        ...
        #one_pop = next(iter(tgt_data))
        #pos = tgt_data[one_pop]["POS"]

        windows = gaia_utils.split_genome(
            pos=pos,
            chr_name=chr_name,
